    ...
    <el-dialog v-model="isShowDialog" width="769px">
      ...
      >
        <el-row :gutter="35">
          ...
          <el-col :span="24" class="mb20">
            <el-form-item label="家属电话" prop="ContactPhones">
              <el-input
                v-model="ruleForm.ContactPhones"
                placeholder="请输入家属电话"
              />
            </el-form-item>
          </el-col>
          <el-col :span="24" class="mb20">
            <el-form-item label="设备电话" prop="Phone">
              <el-input
  ...
  setup() {
    ...
    const openDialog = (row: any) => {
      if (row.Id && row.Id != undefined && row.Id != "") {
        ...
        state.ruleForm.Phone=row.Phone;// 设备电话
    ...
    const initForm = () => { 
      ...
      state.ruleForm.ContactPhones = "" ; // 家属电话
      state.ruleForm.Phone = "" ; // 设备电话
