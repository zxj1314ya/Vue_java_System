    ...
    <script src="~/Assets/H+4.9/js/plugins/jqgrid/jquery.jqGrid.min.js"></script>
    <script src="~/Assets/vue-vxe/js/vue/vue.min.js"></script>
    <script src="~/Assets/vue-vxe/js/axios/axios.min.js"></script>
    <script src="~/Assets/vue-vxe/js/xe/xe-ajax.js"></script>
    <script src="~/Assets/vue-vxe/js/xe/xe-utils.js"></script>
    <script src="~/Assets/vue-vxe/js/vxe/vxe-table.js"></script>
    <script src="~/Assets/vue-vxe/js/vxe/vxe-table-plugin-export-xlsx.js"></script>
    -->
<template>
<div id="app">
    <vxe-grid ref='xGrid'
